...
const Chatbot = () => {
    ...
    const agregarMensaje = (mensaje) => {
        ...
        agregar.innerHTML += `<div className="bot-response animation"><span className="bot-name">Robó</span><p className='agregado'>${ <FontAwesomeIcon icon={ faRobot } />}${mensaje}</p></div>`;
    };
